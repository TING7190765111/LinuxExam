...
public class UpdateStudents extends HttpServlet {
   ...
   final static String SQL_UPDATE_STUDENTS = "UPDATE students SET name= ? ,age= ? WHERE id =?";
   ...
   public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      out.println(UpdateStudents(req));
      out.flush();
      out.close();
   }
   ...
   private int UpdateStudents(Students req) {
      ...
      try {
         ...
         stmt = conn.prepareStatement(SQL_UPDATE_STUDENTS);
